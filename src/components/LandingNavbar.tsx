      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-3">
            <div className={`p-2 rounded-lg ${isScrolled ? 'bg-school-green-50' : 'bg-white/10 backdrop-blur-sm'}`}>
              <img 
                src="/asashs-logo.png" 
                alt="ASASHS Logo" 
                className="w-10 h-10"
            ...
            <div>
              <h1 className={`text-xl font-bold ${isScrolled ? 'text-school-green-800' : 'text-white'}`}>
                ASASHS
              </h1>
              <p className={`text-xs tracking-wider ${isScrolled ? 'text-school-green-600' : 'text-white/90'}`}>
